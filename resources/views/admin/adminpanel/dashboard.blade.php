...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('dshb/assets/css/style.css') }}" />
        <!--[if lt IE 9]>
        ...
        <div class="main-wrapper">
            <div class="header">
                <div class="header-left">
                    <a href="index-2.html" class="logo"> <img src="assets/img/logo.png" width="35" height="35" alt="" /> <span>Hospital</span> </a>
                </div>
                ...
                <ul class="nav user-menu float-right">
                    ...
                    <li class="nav-item dropdown has-arrow">
                        ...
                        <a class="dropdown-item" href="{{route('Administrator.cms')}}">Cms</a>
