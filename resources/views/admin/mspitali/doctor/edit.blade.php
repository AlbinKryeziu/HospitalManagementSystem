                    ...
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="surname-name" type="text" name="age" class="form-control  " disabled   data-toggle="tooltip" data-placement="left" title="Tooltip on left" placeholder="{{ \Carbon\Carbon::parse( $doctor->birthday )->age }}">
                                </div>
                            </div>
